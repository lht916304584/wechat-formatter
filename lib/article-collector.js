...
async function collectArticle({ url, apiKey, baseUrl, fetchImpl = fetch }) {
  ...
  const endpoints = [
    { url: `${base}/api/v1/wechat_mp/web/fetch_mp_article_detail_html?url=${encoded}`, mode: 'html', via: 'tikhub-html', attempts: 2 },
    { url: `${base}/api/v1/wechat_mp/web/fetch_mp_article_detail_json?url=${encoded}`, mode: 'json', via: 'tikhub-json', attempts: 2 },
  ];
